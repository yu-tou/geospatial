...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
--
-- Generated on: 2019-06-20 18:33:55
...
BEGIN
 ...
 RAISE NOTICE 'newly registered AGGREGATE topology.TopoElementArray_agg (topology.TopoElement)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered AGGREGATE topology.TopoElementArray_agg (topology.TopoElement)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered CAST (topology.TopoGeometry AS Geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered CAST (topology.TopoGeometry AS Geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.LayerTrigger ()';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.LayerTrigger ()';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.RelationTrigger ()';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.RelationTrigger ()';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AddTopoGeometryColumn (toponame varchar, schema varchar, tbl varchar, col varchar, ltype varchar, child integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AddTopoGeometryColumn (toponame varchar, schema varchar, tbl varchar, col varchar, ltype varchar, child integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AddTopoGeometryColumn (varchar, varchar, varchar, varchar, varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AddTopoGeometryColumn (varchar, varchar, varchar, varchar, varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.DropTopoGeometryColumn (schema varchar, tbl varchar, col varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.DropTopoGeometryColumn (schema varchar, tbl varchar, col varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.populate_topology_layer ();
 RAISE NOTICE 'newly registered FUNCTION topology.populate_topology_layer ()';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.populate_topology_layer ()';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.CreateTopoGeom (toponame varchar, tg_type integer, layer_id integer, tg_objs topology.TopoElementArray)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.CreateTopoGeom (toponame varchar, tg_type integer, layer_id integer, tg_objs topology.TopoElementArray)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.CreateTopoGeom (toponame varchar, tg_type integer, layer_id integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.CreateTopoGeom (toponame varchar, tg_type integer, layer_id integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GetTopologyName (topoid integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetTopologyName (topoid integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GetTopologyId (toponame varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetTopologyId (toponame varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GetTopologySRID (toponame varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetTopologySRID (toponame varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GetTopoGeomElementArray (toponame varchar, layer_id integer, tgid integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetTopoGeomElementArray (toponame varchar, layer_id integer, tgid integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GetTopoGeomElementArray (tg topology.TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetTopoGeomElementArray (tg topology.TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GetTopoGeomElements (toponame varchar, layerid integer, tgid integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetTopoGeomElements (toponame varchar, layerid integer, tgid integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GetTopoGeomElements (tg topology.TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetTopoGeomElements (tg topology.TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.Geometry (topogeom topology.TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.Geometry (topogeom topology.TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ValidateTopology (toponame varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ValidateTopology (toponame varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.CreateTopology (atopology varchar, srid integer, prec float8, hasZ boolean)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.CreateTopology (atopology varchar, srid integer, prec float8, hasZ boolean)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.CreateTopology (toponame varchar, srid integer, prec float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.CreateTopology (toponame varchar, srid integer, prec float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.CreateTopology (varchar, integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.CreateTopology (varchar, integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.CreateTopology (varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.CreateTopology (varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.DropTopology (atopology varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.DropTopology (atopology varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.TopologySummary (atopology varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.TopologySummary (atopology varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.CopyTopology (atopology varchar, newtopo varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.CopyTopology (atopology varchar, newtopo varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.intersects (tg1 topology.TopoGeometry, tg2 topology.TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.intersects (tg1 topology.TopoGeometry, tg2 topology.TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.equals (tg1 topology.TopoGeometry, tg2 topology.TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.equals (tg1 topology.TopoGeometry, tg2 topology.TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GetNodeByPoint (atopology varchar, apoint geometry, tol1 float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetNodeByPoint (atopology varchar, apoint geometry, tol1 float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GetEdgeByPoint (atopology varchar, apoint geometry, tol1 float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetEdgeByPoint (atopology varchar, apoint geometry, tol1 float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GetFaceByPoint (atopology varchar, apoint geometry, tol1 float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetFaceByPoint (atopology varchar, apoint geometry, tol1 float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology._st_mintolerance (ageom Geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology._st_mintolerance (ageom Geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology._st_mintolerance (atopology varchar, ageom Geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology._st_mintolerance (atopology varchar, ageom Geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AddNode (atopology varchar, apoint geometry, allowEdgeSplitting boolean, setContainingFace boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AddNode (atopology varchar, apoint geometry, allowEdgeSplitting boolean, setContainingFace boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AddNode (atopology varchar, apoint geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AddNode (atopology varchar, apoint geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AddEdge (atopology varchar, aline geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AddEdge (atopology varchar, aline geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AddFace (atopology varchar, apoly geometry, force_new boolean )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AddFace (atopology varchar, apoly geometry, force_new boolean )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.TopoGeo_AddPoint (atopology varchar, apoint geometry, tolerance float8 )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.TopoGeo_AddPoint (atopology varchar, apoint geometry, tolerance float8 )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.TopoGeo_addLinestring (atopology varchar, aline geometry, tolerance float8 )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.TopoGeo_addLinestring (atopology varchar, aline geometry, tolerance float8 )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.TopoGeo_AddPolygon (atopology varchar, apoly geometry, tolerance float8 )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.TopoGeo_AddPolygon (atopology varchar, apoly geometry, tolerance float8 )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.TopoGeo_AddGeometry (atopology varchar, ageom geometry, tolerance float8 )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.TopoGeo_AddGeometry (atopology varchar, ageom geometry, tolerance float8 )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.polygonize (toponame varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.polygonize (toponame varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.TopoElementArray_append (topology.TopoElementArray, topology.TopoElement)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.TopoElementArray_append (topology.TopoElementArray, topology.TopoElement)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GeometryType (tg topology.TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GeometryType (tg topology.TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_GeometryType (tg topology.TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_GeometryType (tg topology.TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.clearTopoGeom (tg topology.TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.clearTopoGeom (tg topology.TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_Simplify (tg topology.TopoGeometry, tolerance float8)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_Simplify (tg topology.TopoGeometry, tolerance float8)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.toTopoGeom (ageom Geometry, atopology varchar, alayer int, atolerance float8 )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.toTopoGeom (ageom Geometry, atopology varchar, alayer int, atolerance float8 )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.toTopoGeom (ageom Geometry, tg topology.TopoGeometry, atolerance float8 )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.toTopoGeom (ageom Geometry, tg topology.TopoGeometry, atolerance float8 )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.TopoGeom_addElement (tg topology.TopoGeometry, el topology.TopoElement);
 RAISE NOTICE 'newly registered FUNCTION topology.TopoGeom_addElement (tg topology.TopoGeometry, el topology.TopoElement)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.TopoGeom_addElement (tg topology.TopoGeometry, el topology.TopoElement)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
DO $$
BEGIN
 ALTER EXTENSION postgis_topology ADD FUNCTION topology.TopoGeom_remElement (tg topology.TopoGeometry, el topology.TopoElement);
 RAISE NOTICE 'newly registered FUNCTION topology.TopoGeom_remElement (tg topology.TopoGeometry, el topology.TopoElement)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.TopoGeom_remElement (tg topology.TopoGeometry, el topology.TopoElement)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology._AsGMLNode (id int, point geometry, nsprefix_in text, prec int, options int, idprefix text, gmlver int)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology._AsGMLNode (id int, point geometry, nsprefix_in text, prec int, options int, idprefix text, gmlver int)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology._AsGMLEdge (edge_id int, start_node int,end_node int, line geometry, visitedTable regclass, nsprefix_in text, prec int, options int, idprefix text, gmlver int)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology._AsGMLEdge (edge_id int, start_node int,end_node int, line geometry, visitedTable regclass, nsprefix_in text, prec int, options int, idprefix text, gmlver int)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology._AsGMLFace (toponame text, face_id int, visitedTable regclass, nsprefix_in text, prec int, options int, idprefix text, gmlver int)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology._AsGMLFace (toponame text, face_id int, visitedTable regclass, nsprefix_in text, prec int, options int, idprefix text, gmlver int)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AsGML (tg topology.TopoGeometry, nsprefix_in text, precision_in int, options_in int, visitedTable regclass, idprefix text, gmlver int)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AsGML (tg topology.TopoGeometry, nsprefix_in text, precision_in int, options_in int, visitedTable regclass, idprefix text, gmlver int)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AsGML (tg topology.TopoGeometry,nsprefix text, prec int, options int, visitedTable regclass, idprefix text)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AsGML (tg topology.TopoGeometry,nsprefix text, prec int, options int, visitedTable regclass, idprefix text)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AsGML (tg topology.TopoGeometry, nsprefix text, prec int, options int, vis regclass)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AsGML (tg topology.TopoGeometry, nsprefix text, prec int, options int, vis regclass)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AsGML (tg topology.TopoGeometry, nsprefix text, prec int, opts int)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AsGML (tg topology.TopoGeometry, nsprefix text, prec int, opts int)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AsGML (tg topology.TopoGeometry, nsprefix text)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AsGML (tg topology.TopoGeometry, nsprefix text)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AsGML (tg topology.TopoGeometry, visitedTable regclass)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AsGML (tg topology.TopoGeometry, visitedTable regclass)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AsGML (tg topology.TopoGeometry, visitedTable regclass, nsprefix text)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AsGML (tg topology.TopoGeometry, visitedTable regclass, nsprefix text)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AsGML (tg topology.TopoGeometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AsGML (tg topology.TopoGeometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AsTopoJSON (tg topology.TopoGeometry, edgeMapTable regclass)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AsTopoJSON (tg topology.TopoGeometry, edgeMapTable regclass)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_GetFaceEdges (toponame varchar, face_id integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_GetFaceEdges (toponame varchar, face_id integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_NewEdgeHeal (toponame varchar, e1id integer, e2id integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_NewEdgeHeal (toponame varchar, e1id integer, e2id integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_ModEdgeHeal (toponame varchar, e1id integer, e2id integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_ModEdgeHeal (toponame varchar, e1id integer, e2id integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_RemEdgeNewFace (toponame varchar, e1id integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_RemEdgeNewFace (toponame varchar, e1id integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_RemEdgeModFace (toponame varchar, e1id integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_RemEdgeModFace (toponame varchar, e1id integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_GetFaceGeometry (toponame varchar, aface integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_GetFaceGeometry (toponame varchar, aface integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_AddIsoNode (atopology varchar, aface integer, apoint geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_AddIsoNode (atopology varchar, aface integer, apoint geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_MoveIsoNode (atopology character varying, anode integer, apoint geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_MoveIsoNode (atopology character varying, anode integer, apoint geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_RemoveIsoNode (atopology varchar, anode integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_RemoveIsoNode (atopology varchar, anode integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_RemIsoNode (varchar, integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_RemIsoNode (varchar, integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_RemoveIsoEdge (atopology varchar, anedge integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_RemoveIsoEdge (atopology varchar, anedge integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_NewEdgesSplit (atopology varchar, anedge integer, apoint geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_NewEdgesSplit (atopology varchar, anedge integer, apoint geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_ModEdgeSplit (atopology varchar, anedge integer, apoint geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_ModEdgeSplit (atopology varchar, anedge integer, apoint geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_AddIsoEdge (atopology varchar, anode integer, anothernode integer, acurve geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_AddIsoEdge (atopology varchar, anode integer, anothernode integer, acurve geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology._ST_AdjacentEdges (atopology varchar, anode integer, anedge integer)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology._ST_AdjacentEdges (atopology varchar, anode integer, anedge integer)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_ChangeEdgeGeom (atopology varchar, anedge integer, acurve geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_ChangeEdgeGeom (atopology varchar, anedge integer, acurve geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_AddEdgeNewFaces (atopology varchar, anode integer, anothernode integer, acurve geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_AddEdgeNewFaces (atopology varchar, anode integer, anothernode integer, acurve geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_AddEdgeModFace (atopology varchar, anode integer, anothernode integer, acurve geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_AddEdgeModFace (atopology varchar, anode integer, anothernode integer, acurve geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_InitTopoGeo (atopology varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_InitTopoGeo (atopology varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.ST_CreateTopoGeo (atopology varchar, acollection geometry)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.ST_CreateTopoGeo (atopology varchar, acollection geometry)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GetRingEdges (atopology varchar, anedge int, maxedges int )';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetRingEdges (atopology varchar, anedge int, maxedges int )';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.GetNodeEdges (atopology varchar, anode int)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.GetNodeEdges (atopology varchar, anode int)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.AddToSearchPath (a_schema_name varchar)';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.AddToSearchPath (a_schema_name varchar)';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered FUNCTION topology.postgis_topology_scripts_installed ()';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered FUNCTION topology.postgis_topology_scripts_installed ()';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered TYPE topology.ValidateTopology_ReturnType';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered TYPE topology.ValidateTopology_ReturnType';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered TYPE topology.TopoGeometry';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered TYPE topology.TopoGeometry';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered TYPE topology.TopoElement';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered TYPE topology.TopoElement';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered TYPE topology.TopoElementArray';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered TYPE topology.TopoElementArray';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
...
BEGIN
 ...
 RAISE NOTICE 'newly registered TYPE topology.GetFaceEdges_ReturnType';
EXCEPTION WHEN object_not_in_prerequisite_state THEN
  IF SQLERRM ~ '\mpostgis_topology\M'
  THEN
    RAISE NOTICE 'already registered TYPE topology.GetFaceEdges_ReturnType';
  ELSE
    RAISE EXCEPTION '%', SQLERRM;
  END IF;
END;
