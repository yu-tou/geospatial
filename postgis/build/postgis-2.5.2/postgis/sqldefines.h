...
#define POSTGIS_LIB_VERSION '2.5.2'
...
#define _POSTGIS_SQL_SELECT_POSTGIS_BUILD_DATE 'SELECT ''2019-06-19 23:43:37''::text AS version'
#define _POSTGIS_SQL_SELECT_POSTGIS_PGSQL_VERSION 'SELECT ''94''::text AS version'

#ifdef POSTGIS_SVN_REVISION
#define _POSTGIS_SQL_SELECT_POSTGIS_SCRIPTS_VERSION $$ SELECT '2.5.2'::text || ' r' || POSTGIS_SVN_REVISION::text AS version $$
#else
#define _POSTGIS_SQL_SELECT_POSTGIS_SCRIPTS_VERSION $$ SELECT '2.5.2'::text AS version $$
#endif
